...
const AnimeMascot3D = ({ mood = 'neutral', message, position = 'right' }) => {
    const containerRef = useRef(null);

    // 3D rotation animation based on mood
    useEffect(() => {
        ...
        const animate = () => {
            switch (mood) {
                case 'excited':
                    rotationY += 2;
                    rotationX = Math.sin(rotationY * 0.05) * 5;
                    break;
                case 'happy':
                    rotationY += 0.5;
                    rotationX = Math.sin(rotationY * 0.03) * 3;
                    break;
                case 'thinking':
                    rotationY += 0.3;
                    rotationX = Math.sin(rotationY * 0.02) * 2;
                    break;
                case 'sad':
                    rotationX = -3;
                    rotationY = 0;
                ...
                default:
                    rotationY += 0.2;
                    rotationX = Math.sin(rotationY * 0.01) * 1;
            }
    ...
    const variants = {
        ...
        thinking: { transition: { repeat: Infinity, duration: 3 } },
        sad: { y: 5 }
    };
                ...
                >
                    ...
                    >
                        <svg viewBox="0 0 200 250" className="w-full h-full">
                            <defs>
                                <linearGradient id="hairGradient3D" x1="0%" y1="0%" x2="0%" y2="100%">
                                    <stop offset="0%" stopColor="#1A1A1A" />
                                    <stop offset="50%" stopColor="#2C2C2C" />
                                    <stop offset="100%" stopColor="#0F0F0F" />
                                </linearGradient>
                                <linearGradient id="skinGradient3D" x1="0%" y1="0%" x2="0%" y2="100%">
                                    <stop offset="0%" stopColor="#FFF5E6" />
                                    <stop offset="100%" stopColor="#FFE5CC" />
                                </linearGradient>
                                <linearGradient id="ribbonGradient3D" x1="0%" y1="0%" x2="100%" y2="100%">
                            ...
                            {/* Back Hair with depth */}
                            <path d="M35 55 Q 50 25 100 35 Q 150 25 165 55 L 175 220 Q 150 245 100 245 Q 50 245 25 220 Z" fill="url(#hairGradient3D)" filter="url(#shadow3D)" />
                            <path d="M30 60 Q 45 30 100 40 Q 155 30 170 60 L 180 215 Q 155 240 100 240 Q 45 240 20 215 Z" fill="url(#hairGradient3D)" opacity="0.7" />

                            {/* Body/Uniform */}
                            <g transform="translate(0, 140)">
                                <path d="M45 0 Q 15 15 5 75 L 195 75 Q 185 15 155 0 L 100 8 Z" fill="#1E293B" filter="url(#shadow3D)" />
                            ...
                            {/* Neck */}
                            <path d="M85 120 L 85 145 L 115 145 L 115 120" fill="url(#skinGradient3D)" />
                            <path d="M85 145 Q 100 155 115 145" fill="url(#skinGradient3D)" />

                            {/* Face */}
                            <ellipse cx="100" cy="85" rx="45" ry="50" fill="url(#skinGradient3D)" filter="url(#shadow3D)" />

                            {/* Front Hair */}
                            <path d="M50 55 L 50 105 L 60 105 L 55 55" fill="url(#hairGradient3D)" />
                            <path d="M150 55 L 150 105 L 140 105 L 145 55" fill="url(#hairGradient3D)" />
                            <path d="M55 50 Q 75 75 100 60 Q 125 75 145 50 L 145 30 Q 100 20 55 30 Z" fill="url(#hairGradient3D)" />
                            <path d="M95 30 L 95 60 L 105 60 L 105 30 Z" fill="url(#hairGradient3D)" opacity="0.3" />

                            {/* Hair Ribbons with 3D effect */}
                            <g transform="translate(40, 50)">
                                <ellipse cx="0" cy="0" rx="8" ry="12" fill="url(#ribbonGradient3D)" filter="url(#shadow3D)" />
                    ...
                    {/* Side Face (for 3D depth illusion) */}
                    <div
                        style={{
                            position: 'absolute',
                            width: '100%',
                    ...
                    >
                        <svg viewBox="0 0 200 250" className="w-full h-full">
                            <path d="M0 0 L 0 250 L 20 250 L 20 0 Z" fill="url(#hairGradient3D)" />
                        </svg>
                    </div>
                </div>
            </motion.div>
